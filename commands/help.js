...
.addField("Health Baseline", "`Items: .health <it> <level> [itemType]`\n`Ingredients: .health <in> <level> <tier> [profession]`", false)
.addField("Lifesteal Baseline", "`Items: .health <it> <level> [itemType]`\n`Ingredients: .health <in> <level> <tier> [profession]`", false)
.addField("Poison Baseline", "`Items: .poison <it> <level> [itemType] [poisonMultiplier]`\n`Ingredients: .poison <in> <level> <tier> [profession]`", false)
.addField("Raw Regen Baseline", "`Items: .hr <it> <level> [itemType]`\n`Ingredients: .hr <in> <level> <tier> [profession]`", false)
.addField("Raw Melee Baseline", "`Items: .rm <it> <level> [itemType]`\n`Ingredients: .rm <in> <level> <tier> [profession]`", false)
.addField("Raw Spell Baseline", "`Items: .rs <it> <level> [itemType]`\n`Ingredients: .rs <in> <level> <tier> [profession]`", false)
